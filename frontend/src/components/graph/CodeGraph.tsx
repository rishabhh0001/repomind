...
// ⚡ Bolt: Memoize custom nodes to prevent re-rendering them unless data/selected changes.
// This significantly improves performance during panning and zooming in React Flow.
